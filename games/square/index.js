...
// include: /var/folders/kr/363mg_fx3r1502x8wh7wnv6h0000gn/T/tmp9qzla59j.js
...
// end include: /var/folders/kr/363mg_fx3r1502x8wh7wnv6h0000gn/T/tmp9qzla59j.js
// include: /var/folders/kr/363mg_fx3r1502x8wh7wnv6h0000gn/T/tmpwyhvc9l3.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/kr/363mg_fx3r1502x8wh7wnv6h0000gn/T/tmpwyhvc9l3.js
// include: /var/folders/kr/363mg_fx3r1502x8wh7wnv6h0000gn/T/tmpa6_q8lav.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/kr/363mg_fx3r1502x8wh7wnv6h0000gn/T/tmpa6_q8lav.js
...
var ASM_CONSTS = {
  124568: () => { if (document.fullscreenElement) return 1; },  
 124614: () => { return document.getElementById('canvas').width; },  
 124666: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124734: () => { document.exitFullscreen(); },  
 124761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 124834: () => { if (document.fullscreenElement) return 1; },  
 124880: () => { return document.getElementById('canvas').width; },  
 124932: () => { return screen.width; },  
 124957: () => { document.exitFullscreen(); },  
 124984: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 125117: () => { return window.innerWidth; },  
 125143: () => { return window.innerHeight; },  
 125170: () => { if (document.fullscreenElement) return 1; },  
 125216: () => { return document.getElementById('canvas').width; },  
 125268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125336: () => { if (document.fullscreenElement) return 1; },  
 125382: () => { return document.getElementById('canvas').width; },  
 125434: () => { return screen.width; },  
 125459: () => { return window.innerWidth; },  
 125485: () => { return window.innerHeight; },  
 125512: () => { if (document.fullscreenElement) return 1; },  
 125558: () => { return document.getElementById('canvas').width; },  
 125610: () => { return screen.width; },  
 125635: () => { document.exitFullscreen(); },  
 125662: () => { if (document.fullscreenElement) return 1; },  
 125708: () => { return document.getElementById('canvas').width; },  
 125760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 125828: () => { document.exitFullscreen(); },  
 125855: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 125913: () => { return screen.width; },  
 125938: () => { return screen.height; },  
 125964: () => { return window.screenX; },  
 125991: () => { return window.screenY; },  
 126018: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 126071: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 126142: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 126199: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 126455: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 126526: () => { if (document.fullscreenElement) return 1; },  
 126572: () => { return window.innerWidth; },  
 126598: () => { return window.innerHeight; },  
 126625: () => { if (document.pointerLockElement) return 1; }
};
...
var _game_parent_window_size_changed = Module['_game_parent_window_size_changed'] = makeInvalidEarlyAccess('_game_parent_window_size_changed');
...
function assignWasmExports(wasmExports) {
  ...
  Module['_game_init_window'] = _game_init_window = createExportWrapper('game_init_window', 1);
  Module['_game_init'] = _game_init = createExportWrapper('game_init', 1);
  ...
  Module['_game_update'] = _game_update = createExportWrapper('game_update', 1);
  Module['_game_should_run'] = _game_should_run = createExportWrapper('game_should_run', 1);
  Module['_main_end'] = _main_end = createExportWrapper('main_end', 0);
  Module['_game_shutdown'] = _game_shutdown = createExportWrapper('game_shutdown', 1);
  Module['_game_shutdown_window'] = _game_shutdown_window = createExportWrapper('game_shutdown_window', 1);
  Module['_web_window_size_changed'] = _web_window_size_changed = createExportWrapper('web_window_size_changed', 2);
  Module['_game_parent_window_size_changed'] = _game_parent_window_size_changed = createExportWrapper('game_parent_window_size_changed', 3);
  Module['_game_memory'] = _game_memory = createExportWrapper('game_memory', 1);
  Module['_game_memory_size'] = _game_memory_size = createExportWrapper('game_memory_size', 1);
  Module['_game_hot_reloaded'] = _game_hot_reloaded = createExportWrapper('game_hot_reloaded', 2);
  Module['_game_force_reload'] = _game_force_reload = createExportWrapper('game_force_reload', 1);
  Module['_game_force_restart'] = _game_force_restart = createExportWrapper('game_force_restart', 1);
